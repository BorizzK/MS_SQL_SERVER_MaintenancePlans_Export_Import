...
::: Delete orphaned maintenance plan
:::
::: Check maintenance plan
::: USE msdb;
::: GO
::: SELECT name, id, packagetype
::: FROM dbo.sysssispackages
::: WHERE name = 'CDW_SERV-1C82CA1_SERV-1C82CA1_0';
:::
::: Check subplan
::: SELECT *
...
::: USE msdb;
::: GO
::: DELETE FROM dbo.sysssispackages
::: WHERE name = 'CDW_SERV-1C82CA1_SERV-1C82CA1_0'
::: AND packagetype = 6;
:::
::: Check maintenance plan
...
:::     WHERE name = N'EveryDay_Backup_22122025_ 9272970_12206'
::: );
...
::: DELETE FROM dbo.sysssispackages
::: WHERE name = N'EveryDay_Backup_22122025_ 9272970_12206'
:::   AND packagetype = 6; -- 6 = Maintenance Plan
...
::: WHERE plan_id IS NULL; -- не должно остаться

::: Если все три запроса вернут пустой результат, план удалён полностью.